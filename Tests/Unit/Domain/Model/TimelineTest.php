...
namespace Bytedev\BytedevTimeline\Tests\Unit\Domain\Model;
...
/**
 * Test case for class \Bytedev\BytedevTimeline\Domain\Model\Timeline.
 *
 * @copyright Copyright belongs to the respective authors
 * @license http://www.gnu.org/licenses/gpl.html GNU General Public License, version 3 or later
 *
 * @author Patrick Kawczynski <info@bytedev.de>
 */
class TimelineTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
    /**
     * @var \Bytedev\BytedevTimeline\Domain\Model\Timeline
     */
    protected $subject = NULL;

    public function setUp()
    {
        $this->subject = new \Bytedev\BytedevTimeline\Domain\Model\Timeline();
    }
     ...
     * @test
     */
    public function getItemsReturnsInitialValueForDate()
    {
     ...
     * @test
     */
    public function setItemsForObjectStorageContainingDateSetsItems()
    {
        $item = new \Bytedev\BytedevTimeline\Domain\Model\Date();
